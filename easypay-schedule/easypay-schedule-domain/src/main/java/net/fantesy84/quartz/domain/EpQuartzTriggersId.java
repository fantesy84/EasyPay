...
/**
 * EpQuartzTriggersId generated by hbm2java
 */
@Embeddable
public class EpQuartzTriggersId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7212790260201003376L;
	private String schedName;
	private String triggerName;
	private String triggerGroup;

	public EpQuartzTriggersId() {
	}

	public EpQuartzTriggersId(String schedName, String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpQuartzTriggersId))
			return false;
		EpQuartzTriggersId castOther = (EpQuartzTriggersId) other;
