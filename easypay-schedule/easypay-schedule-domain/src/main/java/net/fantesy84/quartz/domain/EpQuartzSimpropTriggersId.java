...
/**
 * EpQuartzSimpropTriggersId generated by hbm2java
 */
@Embeddable
public class EpQuartzSimpropTriggersId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6933884118045847806L;
	private String schedName;
	private String triggerName;
	private String triggerGroup;

	public EpQuartzSimpropTriggersId() {
	}

	public EpQuartzSimpropTriggersId(String schedName, String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpQuartzSimpropTriggersId))
			return false;
		EpQuartzSimpropTriggersId castOther = (EpQuartzSimpropTriggersId) other;
