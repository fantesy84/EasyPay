...
/**
 * EpQuartzCronTriggersId generated by hbm2java
 */
@Embeddable
public class EpQuartzCronTriggersId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7278083250387487568L;
	private String schedName;
	private String triggerName;
	private String triggerGroup;

	public EpQuartzCronTriggersId() {
	}

	public EpQuartzCronTriggersId(String schedName, String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpQuartzCronTriggersId))
			return false;
		EpQuartzCronTriggersId castOther = (EpQuartzCronTriggersId) other;
