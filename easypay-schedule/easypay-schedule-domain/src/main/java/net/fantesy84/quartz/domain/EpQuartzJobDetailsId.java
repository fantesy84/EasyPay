...
/**
 * EpQuartzJobDetailsId generated by hbm2java
 */
@Embeddable
public class EpQuartzJobDetailsId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2858022707578266970L;
	private String schedName;
	private String jobName;
	private String jobGroup;

	public EpQuartzJobDetailsId() {
	}

	public EpQuartzJobDetailsId(String schedName, String jobName, String jobGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpQuartzJobDetailsId))
			return false;
		EpQuartzJobDetailsId castOther = (EpQuartzJobDetailsId) other;
