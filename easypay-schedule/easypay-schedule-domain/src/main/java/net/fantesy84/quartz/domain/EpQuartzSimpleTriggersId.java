...
/**
 * EpQuartzSimpleTriggersId generated by hbm2java
 */
@Embeddable
public class EpQuartzSimpleTriggersId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8341611880898352576L;
	private String schedName;
	private String triggerName;
	private String triggerGroup;

	public EpQuartzSimpleTriggersId() {
	}

	public EpQuartzSimpleTriggersId(String schedName, String triggerName, String triggerGroup) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpQuartzSimpleTriggersId))
			return false;
		EpQuartzSimpleTriggersId castOther = (EpQuartzSimpleTriggersId) other;
